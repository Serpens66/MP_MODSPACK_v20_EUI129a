...
print( "Lua memory in use:", ToNumber( collectgarbage("count") * 1024, "#,###,###,###" ), "Starting game...\n", ("-"):rep(100) )
...
function()
	print( "Lua memory in use:", ToNumber( collectgarbage("count") * 1024, "#,###,###,###" ), "SequenceGameInitComplete...\n", ("-"):rep(100) )
