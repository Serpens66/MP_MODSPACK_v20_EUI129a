...
local EndTurnState = {
    ...
    [EndTurnBlockingTypes.ENDTURN_BLOCKING_CITY_TILE or -1] = -- comaptible to UI City Expansion mod Serp
		{ NO_FLASHING, L"TXT_KEY_CHOOSE_CITY_TILE", L"TXT_KEY_CHOOSE_CITY_TILE_TT" },
}EndTurnState[-1] = nil
...
--print("HookupNewNotifications")
	-- GameEvents.SetPopulation.Add( OnSetPopulation ) -- serp we dont need them
