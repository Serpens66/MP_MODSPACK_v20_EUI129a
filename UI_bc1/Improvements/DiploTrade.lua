...
ContextPtr:SetShowHideHandler( function( isHide, isInit )
	-- OnShowHide( isHide, isInit );-- the one defined in TradeLogic which got overwritten by Firaxis, leading to the bug. Serp: outcomment this line, because ressources in tradeview are hidden otherwiese, if we do not use the tradelogic.lua from EUI.
